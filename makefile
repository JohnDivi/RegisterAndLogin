...
user-test: o/database.o o/menu.o o/user.o o/user-test.o
	g++ -o tests/program-user-test o/database.o o/menu.o o/user.o o/user-test.o -lssl -lcrypto 

database-test: o/database.o o/menu.o o/user.o o/database-test.o
	g++ -o tests/program-database-test o/database.o o/menu.o o/user.o o/database-test.o -lssl -lcrypto 
